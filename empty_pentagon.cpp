// Code to draw an empty pentagon
...
int main(void)
{
    ...
    window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "Empty Pentagon Drawn by Shubham Khandelwal", NULL, NULL);
    ...
    float vertices[] =
    {
        ...
        scwth / 2 + 300, schei / 2 + 150, 0.0, // top right corner
        scwth / 2 , schei / 2 + 300, 0.0, // topmost corner
        scwth / 2 - 300, schei / 2 + 150, 0.0, // top left corner
        scwth / 2 - 300, schei / 2 - 150, 0.0, // bottom left corner
        scwth / 2 + 300, schei / 2 - 150, 0.0 // bottom right corner
    };
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glDrawArrays(GL_LINE_LOOP, 0, 5); // draw the vertixes
